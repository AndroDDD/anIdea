...
import {
  ...
  nextPhoto,
  handleSearch,
} from "./MajorCatalogPhotoBarLogic";
...
interface MajorCatalogPhotoBarInterface {
  ...
  photosTitles: Array<string>;
}

const MajorCatalogPhotoBar: React.FC<MajorCatalogPhotoBarInterface> = ({
  currentIndex,
  setNextPhoto,
  catalogLength,
  photosTitles,
      ...
      <AppBar position={"relative"} style={styles2.appBar}>
        <Toolbar>
          <View style={styles.titleView}>
            <Text style={styles2.titleText}>{photosTitles[currentIndex]}</Text>
          </View>
          <View style={styles.navigationScene}>
            <IconButton
              onClick={() => {
                prevPhoto(currentIndex, setNextPhoto, catalogLength);
              }}
            >
            ...
            <View style={styles.searchScene}>
              <input
                ...
                onChange={(e) => {
                  console.log({ mcpbTitles: photosTitles });
            ...
            <IconButton
              onClick={() => {
                nextPhoto(currentIndex, setNextPhoto, catalogLength);
              }}
            >
...
export default MajorCatalogPhotoBar;

...
function nextPhoto(
  ...
  console.log("clicked Next", { currentIndex, setNextPhoto, catalogLength });
...
function prevPhoto(
  currentIndex: number,
  setPrevPhoto: Function,
  catalogLength: number
) {
  console.log("clicked Prev");
  if (currentIndex - 1 >= 0) {
    setPrevPhoto(currentIndex - 1);
  } else {
    setPrevPhoto(catalogLength - 1);
  }
}
...
export { nextPhoto, prevPhoto, handleSearch, resultButtonNavigation };
